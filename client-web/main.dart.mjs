...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1294: (x0,x1) => x0.getUserMedia(x1),
      _1295: x0 => x0.getSupportedConstraints(),
      _1296: x0 => x0.getVideoTracks(),
      _1297: x0 => x0.getCapabilities(),
      _1298: x0 => x0.getSettings(),
      _1299: (x0,x1,x2) => x0.setProperty(x1,x2),
      _1300: (x0,x1) => x0.append(x1),
      _1301: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1302: x0 => x0.play(),
      _1304: x0 => x0.getTracks(),
      _1305: x0 => x0.stop(),
      _1311: x0 => globalThis.URL.createObjectURL(x0),
      _1318: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1322: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1327: x0 => x0.load(),
      _1328: x0 => globalThis.MediaRecorder.isTypeSupported(x0),
      _1329: x0 => ({type: x0}),
      _1330: (x0,x1) => new Blob(x0,x1),
      _1331: x0 => x0.enumerateDevices(),
      _1332: x0 => new Event(x0),
      ...
      _1341: (x0,x1) => x0.getAttribute(x1),
      ...
      _1367: (x0,x1) => x0.replaceChildren(x1),
      _1368: x0 => x0.decode(),
      ...
      _1391: () => new FileReader(),
      _1393: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1401: x0 => x0.read(),
      _1402: (x0,x1) => x0.getType(x1),
      _1403: x0 => x0.text(),
      _1406: x0 => x0.arrayBuffer(),
      _1407: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1407(f,arguments.length,x0) }),
      _1408: x0 => x0.getAsFile(),
      _1409: Date.now,
      _1411: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1412: s => {
      ...
      _1413: () => new Error().stack,
      _1414: () => typeof dartUseDateNowForTicks !== "undefined",
      _1415: () => 1000 * performance.now(),
      _1416: () => Date.now(),
      _1417: () => {
      ...
      _1419: () => new WeakMap(),
      _1420: (map, o) => map.get(o),
      _1421: (map, o, v) => map.set(o, v),
      _1422: (exn) => exn.toString(),
      _1423: (exn) => exn.stack,
      _1424: (exn) => {
      ...
      _1439: (o, p, r) => o.replaceAll(p, () => r),
      _1440: (o, p, r) => o.replace(p, () => r),
      _1441: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1442: s => s.toUpperCase(),
      _1443: s => s.trim(),
      _1444: s => s.trimLeft(),
      _1445: s => s.trimRight(),
      _1446: (string, times) => string.repeat(times),
      _1447: Function.prototype.call.bind(String.prototype.indexOf),
      _1448: (s, p, i) => s.lastIndexOf(p, i),
      _1449: (string, token) => string.split(token),
      _1450: Object.is,
      _1453: (o, t) => typeof o === t,
      _1454: (o, c) => o instanceof c,
      _1455: o => Object.keys(o),
      _1458: (o, a) => o + a,
      _1485: x0 => new Array(x0),
      _1487: x0 => x0.length,
      _1489: (x0,x1) => x0[x1],
      _1490: (x0,x1,x2) => { x0[x1] = x2 },
      _1493: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1495: x0 => new Int8Array(x0),
      _1496: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1498: x0 => new Uint8ClampedArray(x0),
      _1500: x0 => new Int16Array(x0),
      _1502: x0 => new Uint16Array(x0),
      _1504: x0 => new Int32Array(x0),
      _1506: x0 => new Uint32Array(x0),
      _1508: x0 => new Float32Array(x0),
      _1510: x0 => new Float64Array(x0),
      _1534: x0 => x0.random(),
      ...
      _1557: (x0,x1) => x0.exec(x1),
      _1558: (x0,x1) => x0.test(x1),
      _1559: x0 => x0.pop(),
      _1561: o => o === undefined,
      _1563: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1565: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1566: o => o instanceof RegExp,
      _1567: (l, r) => l === r,
      _1568: o => o,
      _1569: o => o,
      _1570: o => o,
      ...
      _1609: x0 => x0.groups,
      _1610: x0 => x0.flags,
      _1611: x0 => x0.multiline,
      _1612: x0 => x0.ignoreCase,
      _1613: x0 => x0.unicode,
      _1614: x0 => x0.dotAll,
      _1615: (x0,x1) => { x0.lastIndex = x1 },
      _1616: (o, p) => p in o,
      _1617: (o, p) => o[p],
      _1618: (o, p, v) => o[p] = v,
      _1620: () => new XMLHttpRequest(),
      ...
      _1633: (x0,x1) => new WebSocket(x0,x1),
      _1634: (x0,x1) => x0.send(x1),
      _1635: (x0,x1,x2) => x0.close(x1,x2),
      _1637: x0 => x0.close(),
      _1641: x0 => new DecompressionStream(x0),
      _1642: x0 => x0.getWriter(),
      _1643: (x0,x1) => x0.write(x1),
      _1644: x0 => x0.close(),
      ...
      _1650: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1650(f,arguments.length,x0,x1,x2) }),
      _1651: (x0,x1) => x0.forEach(x1),
      _1652: x0 => x0.abort(),
      _1653: () => new AbortController(),
      _1654: x0 => x0.cancel(),
      _1660: x0 => x0.facingMode,
      _1661: x0 => x0.facingMode,
      _1670: (x0,x1) => x0.key(x1),
      _1671: o => o instanceof Array,
      _1672: (a, i) => a.push(i),
      _1675: (a, l) => a.length = l,
      _1676: a => a.pop(),
      _1677: (a, i) => a.splice(i, 1),
      _1679: (a, s, e) => a.slice(s, e),
      _1681: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1682: a => a.length,
      _1684: (a, i) => a[i],
      _1685: (a, i, v) => a[i] = v,
      _1687: o => {
      ...
      _1710: (t, s) => t.set(s),
      _1711: l => new DataView(new ArrayBuffer(l)),
      _1712: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1713: o => o.byteLength,
      _1714: o => o.buffer,
      ...
      _1755: () => globalThis.window,
      _1760: (x0,x1) => { x0.height = x1 },
      _1762: (x0,x1) => { x0.width = x1 },
      _1764: (x0,x1) => { x0.pointerEvents = x1 },
      _1767: x0 => x0.head,
      _1768: x0 => x0.classList,
      _1772: (x0,x1) => { x0.innerText = x1 },
      _1773: x0 => x0.style,
      _1775: x0 => x0.sheet,
      _1776: x0 => x0.src,
      _1777: (x0,x1) => { x0.src = x1 },
      _1778: x0 => x0.naturalWidth,
      _1779: x0 => x0.naturalHeight,
      _1786: x0 => x0.offsetX,
      _1787: x0 => x0.offsetY,
      _1788: x0 => x0.button,
      _1795: x0 => x0.status,
      ...
      _1847: (x0,x1) => { x0.responseType = x1 },
      _1848: x0 => x0.response,
      _1924: x0 => x0.style,
      _1937: (x0,x1) => { x0.oncancel = x1 },
      _1943: (x0,x1) => { x0.onchange = x1 },
      _1983: (x0,x1) => { x0.onerror = x1 },
      _2283: (x0,x1) => { x0.download = x1 },
      _2308: (x0,x1) => { x0.href = x1 },
      _2527: x0 => x0.error,
      _2530: x0 => x0.srcObject,
      _2531: (x0,x1) => { x0.srcObject = x1 },
      _2555: (x0,x1) => { x0.autoplay = x1 },
      _2563: (x0,x1) => { x0.muted = x1 },
      _2578: x0 => x0.code,
      _2579: x0 => x0.message,
      _2850: (x0,x1) => { x0.accept = x1 },
      _2864: x0 => x0.files,
      _2890: (x0,x1) => { x0.multiple = x1 },
      _2908: (x0,x1) => { x0.type = x1 },
      _3606: x0 => x0.items,
      _3609: (x0,x1) => x0[x1],
      _3613: x0 => x0.length,
      _3616: x0 => x0.kind,
      _3617: x0 => x0.type,
      _3623: () => globalThis.window,
      _3666: x0 => x0.location,
      _3685: x0 => x0.navigator,
      _3689: x0 => x0.screen,
      _3949: x0 => x0.localStorage,
      _3964: x0 => x0.hostname,
      _4051: x0 => x0.clipboard,
      _4053: x0 => x0.geolocation,
      _4056: x0 => x0.mediaDevices,
      _4058: x0 => x0.permissions,
      _4072: x0 => x0.userAgent,
      _4073: x0 => x0.vendor,
      _4123: x0 => x0.data,
      _4280: x0 => x0.length,
      _4497: x0 => x0.readyState,
      _4506: x0 => x0.protocol,
      _4510: (x0,x1) => { x0.binaryType = x1 },
      _4513: x0 => x0.code,
      _4514: x0 => x0.reason,
      _6181: x0 => x0.type,
      _6182: x0 => x0.target,
      _6222: x0 => x0.signal,
      _6294: () => globalThis.document,
      _6376: x0 => x0.body,
      _6705: x0 => x0.tagName,
      _6707: (x0,x1) => { x0.id = x1 },
      _6734: x0 => x0.children,
      _7142: x0 => x0.ctrlKey,
      _7143: x0 => x0.shiftKey,
      _7144: x0 => x0.altKey,
      _7145: x0 => x0.metaKey,
      _8053: x0 => x0.value,
      _8055: x0 => x0.done,
      ...
      _8231: x0 => x0.type,
      _8237: x0 => x0.name,
      _8238: x0 => x0.lastModified,
      _8243: x0 => x0.length,
      _8248: x0 => x0.result,
      _8740: x0 => x0.url,
      _8742: x0 => x0.status,
      _8744: x0 => x0.statusText,
      _8745: x0 => x0.headers,
      _8746: x0 => x0.body,
      _8817: x0 => x0.clipboardData,
      _8821: x0 => x0.types,
      _8866: x0 => x0.readable,
      _8867: x0 => x0.writable,
      _9008: x0 => x0.type,
      _9040: x0 => x0.orientation,
      _9560: x0 => x0.facingMode,
      _9774: x0 => x0.width,
      _9776: x0 => x0.height,
      _9859: x0 => x0.deviceId,
      _9860: x0 => x0.kind,
      _9861: x0 => x0.label,
      _11127: (x0,x1) => { x0.cursor = x1 },
      _11137: (x0,x1) => { x0.display = x1 },
      _11301: (x0,x1) => { x0.height = x1 },
      _11495: (x0,x1) => { x0.objectFit = x1 },
      _11513: (x0,x1) => { x0.opacity = x1 },
      _11625: (x0,x1) => { x0.pointerEvents = x1 },
      _11923: (x0,x1) => { x0.transform = x1 },
      _11927: (x0,x1) => { x0.transformOrigin = x1 },
      _11991: (x0,x1) => { x0.width = x1 },
      _12359: x0 => x0.name,
      _12360: x0 => x0.message,
