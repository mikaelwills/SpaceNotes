...
#[sats(crate = __lib)]
pub(super) struct DeleteFolderArgs {
    pub path: String,
}

impl From<DeleteFolderArgs> for super::Reducer {
    fn from(args: DeleteFolderArgs) -> Self {
        Self::DeleteFolder { path: args.path }
    }
}

impl __sdk::InModule for DeleteFolderArgs {
